...
contract Ownable {
    ...
    modifier onlyOwner {
        require(msg.sender == _owner, "Only the contract owner can access this");
        _;
    }
...
//    @dev Approves another address to transfer the given token ID
    function approve(address to, uint256 tokenId) public {
        ...
        require(to != owner,"Token is already owned by receiver" );

        // TODO require the msg sender to be the owner of the contract or isApprovedForAll() to be true
        require(msg.sender == owner || isApprovedForAll(owner,msg.sender),
                "Sender must be owner or approved operator");
    ...
    function _mint(address to, uint256 tokenId) internal {
        ...
        require(!_exists(tokenId), "Goven token already exists");
        require(to != address(0), "Given address is required");
    ...
    function _transferFrom(address from, address to, uint256 tokenId) internal {
        ...
        require(to != address(0), "tranfer to an invalid address");
...
contract ZhaiToken is ERC721Metadata("Zhai Token","ZHT","https://s3-us-west-2.amazonaws.com/udacity-blockchain/capstone/"){

    function mint(address to,uint tokenId) public onlyOwner whenNotPaused returns(bool){
        _mint(to, tokenId);
